		...
		vBoutonCreerContact.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				try {
					...
					Log.e(AjoutNouvelUtilisateurActivity.class.toString(), "Tache de mise à jour d'un contact interrompue : " + e.getMessage()); 
				} catch (ExecutionException e) {
					...
					Log.e(AjoutNouvelUtilisateurActivity.class.toString(), "Message réponse non recu : " + e.getMessage());
				}
			}
		});
